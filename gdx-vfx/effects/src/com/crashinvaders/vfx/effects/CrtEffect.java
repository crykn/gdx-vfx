...
public class CrtEffect extends ShaderVfxEffect implements ChainVfxEffect {
    ...
    public CrtEffect(LineStyle lineStyle, float brightnessMin,
            float brightnessMax) {
    ...
    public void rebind() {
        ...
        case VIEWPORT:
            ...
            break;
        case SCREEN:
            program.setUniformf(U_RESOLUTION, tmpVec
    ...
    /**
     * Constant name/ordinal values match the respected #define constants from
     * crt.frag
     */
    public enum LineStyle {
        CROSSLINE_HARD, VERTICAL_HARD, HORIZONTAL_HARD, VERTICAL_SMOOTH, HORIZONTAL_SMOOTH,
    }
