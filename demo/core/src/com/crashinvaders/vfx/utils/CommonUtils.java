...
public class CommonUtils {
	...
	/**
	 * This method actually replicate Integer.compare() to support Android API less
	 * than 19
	 */
	...
	/**
	 * This method actually replicate Float.compare() to support Android API less
	 * than 19
	 */
	...
	/**
	 * This method actually replicate Boolean.compare() to support Android API less
	 * than 19
	 */
	...
	public static Color parseHexColor(String hexCode) {
		...
		default:
			throw new IllegalArgumentException(
					"Wrong format, HEX string value should be either 3, 4, 6 or 8 letters long.");
		}
	}
